...
import '../common/service/local_manager/local_data_manager.dart' as _i10;
...
import '../common/service/local_manager/user_data_datasource/user_data_datasource.impl.dart'
    as _i41;
import '../common/service/navigation/navigation_service.dart' as _i11;
...
import '../data/data_source/remote/module_repositories/temperature_api_repository/temperature_api_repository_impl.dart'
    as _i37;
import '../domain/network/network_info.dart' as _i12;
...
import '../domain/usecases/temperature_usecase/temperature_usecase.dart'
    as _i39;
import '../presentation/modules/admin_screen/bloc/admin_bloc.dart' as _i62;
import '../presentation/modules/camera_demo/camera_bloc/camera_bloc.dart'
    as _i3;
import '../presentation/modules/history/history_bloc/history_bloc.dart' as _i64;
import '../presentation/modules/login_screen/bloc/login_bloc.dart' as _i65;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i64.HistoryBloc>(() => _i64.HistoryBloc(
  ...
  gh.factory<_i65.LoginBloc>(() => _i65.LoginBloc(
        gh<_i23.PatientUsecase>(),
        gh<_i18.NotificationUsecase>(),
        gh<_i12.NetworkInfo>(),
  ...
  gh.factory<_i66.NotificationBloc>(
      () => _i66.NotificationBloc(gh<_i18.NotificationUsecase>()));
  gh.factory<_i67.OCRScannerBloc>(() => _i67.OCRScannerBloc(
        gh<_i12.NetworkInfo>(),
        gh<_i53.BloodPressureUsecase>(),
        gh<_i57.BloodSugarUsecase>(),
        gh<_i39.TemperatureUsecase>(),
  ...
  gh.factory<_i68.SettingBloc>(() => _i68.SettingBloc(
        gh<_i12.NetworkInfo>(),
        gh<_i23.PatientUsecase>(),
        gh<_i8.DoctorInforUsecase>(),
        gh<_i27.RelativeInforUsecase>(),
...
class _$DioProvider extends _i69.DioProvider {}
